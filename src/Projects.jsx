    ...
    <VStack id="soundwave" w={"100%"} minH={{base: "auto", md: "100vh"}} bgRepeat={"no-repeat"} bgColor={"purple.900"}>
        ...
        <Stack mt={8} minH={"70%"} flexDirection={{base: "column", md:"row"}}>
            <Card.Root border={"none"} bgColor={"transparent"}  bgSize={"cover"} w={{base: "100%", md:"70%"}} maxW={{base: "100%", md:"70%"}}>
                <Card.Header width={{base: "100%", md: "80%"}} filter="auto" backdropBlur="sm"  >
                    <HStack  bgColor={"#641ba3"}>
                        <VStack minH="100%"><FaArrowRightLong color="white"/></VStack>
                        <Card.Title fontSize={{base: "sm", md: "1xl"}} as="span" color={"white"}>
                ...
                <Card.Body>
                    <Container maxW="2xl" bgColor={"#641ba3"} mt={4} >
                        <Card.Title color={"white"} fontSize={{base: "sm", md: "xl"}} >Contexte</Card.Title>
                        <Card.Description fontSize={{base: "2xs", md: "sm"}}  color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"#641ba3"} my={4} pt={2}>
                        <Card.Title color={"white"} fontSize={{base: "sm", md: "xl"}} >Tâches réalisées</Card.Title>
                        <Box fontSize={{base: "2xs", md: "sm"}}  as="ul"  ml={8} listStyleType="circle" color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"#641ba3"} pt={2} >
                        <Card.Title color={"white"} fontSize={{base: "sm", md: "xl"}} >Technologies et Outils</Card.Title>
                        <Card.Description  color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                            <Flex  bgColor={"#641ba3"} justify="space-between">
                                <Card.Title fontSize={{base: "2xs", md: "sm"}} color={"white"}>
                                    {`  Java, JavaFX, IntelliJ`}
                                </Card.Title>
                                <HStack>
                                    <Image boxSize={{base: "25px", md: "50px"}} bgColor={"white"} src={javaLogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}} src={intelliLogo}></Image>
                                </HStack>
                            </Flex>
                        </Card.Description>
                    </Container>
            ...
            <Card.Root border={"none"} bgColor={"transparent"}  bgSize={"cover"} w={{base: "100%", md:"70%"}} maxW={{base: "100%", md:"70%"}}>
                <Card.Header width="80%" filter="auto" backdropBlur="sm"  >
                    <HStack  bgColor={"blue.700"}>
                        ...
                        <Card.Title as="span" color={"white"} fontSize={{base: "sm", md: "1xl"}}>
                ...
                <Card.Body>
                    <Container maxW="2xl" bgColor={"blue.700"} mt={4} >
                        <Card.Title color={"white"} fontSize={{base: "sm", md: "xl"}} >Contexte</Card.Title>
                        <Card.Description  color={"white"} fontSize={{base: "2xs", md: "sm"}} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"blue.700"} my={4} pt={2}>
                        <Card.Title color={"white"} fontSize={{base: "sm", md: "xl"}} >Tâches réalisées</Card.Title>
                        <Box as="ul" fontSize={{base: "2xs", md: "sm"}} ml={8} listStyleType="circle" color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"blue.700"} pt={2} >
                        ...
                        <Card.Description  color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                            <Flex  justify="space-between">
                                ...
                                <HStack>
                                    <Image boxSize={{base: "25px", md: "50px"}} bgColor={"white"} src={javaLogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}} src={springLogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}} src={reactLogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}} bgColor={"white"} src={bootLogo}></Image>
            ...
            <Card.Root border={"none"} bgColor={"transparent"}  bgSize={"cover"} w={{base: "100%", md:"70%"}} maxW={{base: "100%", md:"70%"}}>
                <Card.Header width="80%" filter="auto" backdropBlur="sm"  >
                    <HStack  bgColor={"yellow.200"}>
                        ...
                        <Card.Title as="span" color={"black"} fontSize={{base: "sm", md: "1xl"}}>
                ...
                <Card.Body>
                    <Container maxW="2xl" bgColor={"yellow.200"} mt={4} >
                        <Card.Title color={"black"} fontSize={{base: "sm", md: "xl"}} >Contexte</Card.Title>
                        <Card.Description fontSize={{base: "2xs", md: "sm"}}  color={"black"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"yellow.200"} my={4} pt={2}>
                        <Card.Title color={"black"} fontSize={{base: "sm", md: "xl"}} >Tâches réalisées</Card.Title>
                        <Box as="ul" fontSize={{base: "2xs", md: "sm"}} ml={8} listStyleType="circle" color={"black"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"yellow.200"} pt={2} >
                        <Card.Title color={"black"} fontSize={{base: "sm", md: "xl"}}>Technologies et Outils</Card.Title>
                        <Card.Description  color={"black"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                            <Flex justify="space-between">
                                <Card.Title fontSize={{base: "2xs", md: "sm"}} color={"black"}>
                                    {`  C++, Qt`}
                                </Card.Title>
                                <HStack>
                                    <Image boxSize={{base: "25px", md: "50px"}} bgColor={"white"} src={cpluslogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}} src={qtLogo}></Image>
                                </HStack>
                            </Flex>
                        </Card.Description>
                    </Container>
                    ...
                    <Container  maxW="2xl" bgColor={"gray.800"} pt={2} >
                        ...
                        <Card.Description  color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                            <Flex  justify="space-between">
                                ...
                                <HStack>
                                    <Image boxSize={{base: "25px", md: "50px"}} bgColor={"white"} src={javaLogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}} bgColor={"white"} src={androidLogo}></Image>
            ...
            <Card.Root border={"none"} bgColor={"transparent"}  bgSize={"cover"} w={{base: "100%", md:"70%"}} maxW={{base: "100%", md:"70%"}}>
                ...
                <Card.Body>
                    <Container maxW="2xl" bgColor={"red.700"} mt={4} >
                        <Card.Title fontSize={{base: "sm", md: "xl"}} color={"white"} >Contexte</Card.Title>
                        <Card.Description fontSize={{base: "2xs", md: "sm"}}  color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"red.700"} my={4} pt={2}>
                        <Card.Title fontSize={{base: "sm", md: "xl"}} color={"white"} >Tâches réalisées</Card.Title>
                        <Box as="ul" fontSize={{base: "2xs", md: "sm"}} ml={8} listStyleType="circle" color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                    ...
                    <Container  maxW="2xl" bgColor={"red.700"} pt={2} >
                        <Card.Title fontSize={{base: "sm", md: "xl"}} color={"white"} >Technologies et Outils</Card.Title>
                        <Card.Description  color={"white"} whiteSpace={"pre-wrap"} textOverflow={"ellipsis"}>
                            <Flex justify="space-between">
                                <Card.Title fontSize={{base: "2xs", md: "sm"}}  color={"white"}>
                                    {`  HTML, CSS, PHP`}
                                ...
                                <HStack>
                                    <Image boxSize={{base: "25px", md: "50px"}} objectFit={"contain"} bgColor={"white"} src={htmlLogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}}  objectFit={"contain"} bgColor={"white"} src={cssLogo}></Image>
                                    <Image boxSize={{base: "25px", md: "50px"}} bgColor={"white"} src={phpLogo}></Image>
