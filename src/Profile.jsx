...
export default function Profile(){
    return <Card.Root shadow={"2xl"} flexDirection={{base: "column"}}  maxW={{base: "95%", md: "60%"}} justifyContent="space-around" bgColor={useColorModeValue("blue.100", "blue.900")}>
            ...
            <Card.Body>
                <Stack direction={{base: "column", md:"row"}}  spaceX={{base: 0, md: 8}}>
                    <Box >
                        ...
                        <Card.Description mt={2} fontSize={{base:"xs", md: "sm"}} maxW={{md: "70%", base: "100%"}}>Ingénieur diplomé de l&apos;Université de Technologie de Compiègne en génie informatique, filière ingénierie des systèmes informatiques</Card.Description>
                        
                        <Card.Description fontSize={{base:"xs", md: "sm"}} mt={2} maxW={{md: "70%", base: "100%"}}>Passionné par le développement, la vidéo et la guitare électrique</Card.Description>
                        <Center>
